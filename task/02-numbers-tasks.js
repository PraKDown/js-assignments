...
function getAngleBetweenVectors(x1, y1, x2, y2) {
    let cosangl = (x1 * x2 + y1 * y2)/ (Math.sqrt(x1 * x1 + y1 * y1) * Math.sqrt(x2 * x2 + y2 * y2));
    if (cosangl == 1) return 0;
    if (cosangl == -1) return Math.PI;
    if (cosangl == 0) return Math.PI / 2;
    if (cosangl == Math.sqrt(3) / 2) return Math.PI / 6;
    if (cosangl == Math.sqrt(2) / 2) return Math.PI / 4;
    if (cosangl == 1 / 2) return Math.PI / 2;
}
